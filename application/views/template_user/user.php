...
<head>
  ...
  <link href="<?php echo base_url() ?>assets/user/assets/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet">
...
<body>
    ...
    <div class="container">
      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li><a href="#speakers">Trainer</a></li>
          <li><a href="#schedule">Daftar Member</a></li>
          <li><a href="#gallery">Gallery</a></li>
          <li><a href="#contact">Contact</a></li>
          <li class="buy-tickets"><a href="<?php echo base_url('administrator/auth') ?>">Login</a></li>
        </ul>
  ...
  <section id="intro">
    <div class="intro-container" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h1 class="mb-4 pb-0">WELCOME<br><span>TO</span> BAYU FITNESS</h1>
    </div>
        ...
        <div class="row contact-info">
          ...
          <div class="col-md-4">
            <div class="contact-address">
              ...
              <h3>Alamat</h3>
              <address>jl. ahmad yani n0 2 narmada</address>
            </div>
          </div>
  ...
  <script src="<?php echo base_url() ?>assets/user/assets/vendor/superfish/superfish.min.js"></script>
  <script src="<?php echo base_url() ?>assets/user/assets/vendor/hoverIntent/hoverIntent.js"></script>
