    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-1">DATA MEMBER </div>
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Sub Menu Member:</h6>
                        <a class="collapse-item" href="<?php echo base_url('administrator/member') ?>">member</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">sub menu paket:</h6>
                        <a class="collapse-item" href="<?php echo base_url('administrator/paket') ?>">Paket</a>
                         <a class="collapse-item" href="<?php echo base_url('administrator/trainer') ?>">trainer</a>
            ...
            <li class="nav-item">
                ...
                <div id="collapsed" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
